...
import kotlinx.android.synthetic.main.fragment_framework.view.*
...
class FrameworkFragment : BaseFragment(), AdapterView.OnItemClickListener{
    ...
    override fun initView(): View? {
        mView = View.inflate(mContext, R.layout.fragment_framework, null)
