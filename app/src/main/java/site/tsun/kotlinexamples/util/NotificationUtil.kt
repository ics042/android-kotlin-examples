package site.tsun.kotlinexamples.util
...
class NotificationUtil(val mContext: Context, val notificationId: Int) {
     ...
     */
    public fun sendSingleLineNotification(pendingIntent: PendingIntent, smallIcon: Int, ticker: String, title: String, content: String,
                                            enableSound: Boolean, enableVibrate: Boolean, enableLights: Boolean) {
     ...
     */
    public fun sendMultipleLinesNotification(pendingIntent: PendingIntent, smallIcon: Int, ticker: String, title: String, content: String,
                                          enableSound: Boolean, enableVibrate: Boolean, enableLights: Boolean) {
     ...
     * only be supported in higher android version
     */
    public fun sendInboxNotification(pendingIntent: PendingIntent, smallIcon: Int, ticker: String, title: String, content: String,
     ...
     */
    public fun sendHeadsUpNotification(pendingIntent: PendingIntent, pushPendingIntent: PendingIntent, smallIcon: Int, ticker: String, title: String, content: String,
                                          enableSound: Boolean, enableVibrate: Boolean, enableLights: Boolean) {
        initCompatBuilder(pendingIntent, smallIcon, ticker, title, content, enableSound, enableVibrate, enableLights)
